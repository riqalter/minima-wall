...
<body>
    <h1 class="title">Minima Wall</h1>

    <div class="icons">
        <!-- GitHub -->
        <a href="https://github.com/riqalter/minima-wall" target="_blank" title="GitHub">
    ...
    <div class="footer">
        ...
        <p>Website by <a href="https://github.com/riqalter">Mikail Thoriq</a>, &copy; <?= date('Y'); ?></p>
    </div>
    ...
    <script type="text/javascript">
        ...
        // jika server IMGPROXY_PREFIX gagal/error, fallback ke server backup
